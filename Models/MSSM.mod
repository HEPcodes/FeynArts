...
Appearance[ Index[Generation | Chargino | Neutralino, i_Integer] ] :=
  Alph[i + 8] 

Appearance[ Index[Sfermion, i_Integer] ] := Alph[i + 18]
...
TheLabel[ S[12, {sf_, 1}] ] :=
  ComposedChar["e", Null, Appearance[sf], "\\tilde"];
TheLabel[ S[12, {sf_, 2}] ] :=
  ComposedChar["\\mu", Null, Appearance[sf], "\\tilde"];
TheLabel[ S[12, {sf_, 3}] ] :=
  ComposedChar["\\tau", Null, Appearance[sf], "\\tilde"];
TheLabel[ S[13, {sf_, 1, ___}] ] :=
  ComposedChar["u", Null, Appearance[sf], "\\tilde"];
TheLabel[ S[13, {sf_, 2, ___}] ] :=
  ComposedChar["c", Null, Appearance[sf], "\\tilde"];
TheLabel[ S[13, {sf_, 3, ___}] ] :=
  ComposedChar["t", Null, Appearance[sf], "\\tilde"];
TheLabel[ S[14, {sf_, 1, ___}] ] :=
  ComposedChar["d", Null, Appearance[sf], "\\tilde"];
TheLabel[ S[14, {sf_, 2, ___}] ] :=
  ComposedChar["s", Null, Appearance[sf], "\\tilde"];
TheLabel[ S[14, {sf_, 3, ___}] ] :=
  ComposedChar["b", Null, Appearance[sf], "\\tilde"]
...
NoGeneration1 = ExcludeParticles ->
  {F[_, {1, ___}], S[11, {1, ___}], S[12 | 13 | 14, {_, 1, ___}]}

NoGeneration2 = ExcludeParticles ->
  {F[_, {2, ___}], S[11, {2, ___}], S[12 | 13 | 14, {_, 2, ___}]}

NoGeneration3 = ExcludeParticles ->
  {F[_, {3, ___}], S[11, {3, ___}], S[12 | 13 | 14, {_, 3, ___}]}
...
M$CouplingMatrices = {C[S[6], -S[6], V[1]] == {{I*EL}}, C[S[6], -S[6], V[2]] == 
   ...
   C[V[1], -V[3], V[3]] == {{(-I)*EL}}, C[V[2], -V[3], V[3]] == 
    ...
    {{((-I)*CW*EL*$HKSign)/SW}}, C[S[4], U[3], -U[3]] == {{-(EL*MW)/(2*SW)}}, \

 C[S[4], U[4], -U[4]] == {{(EL*MW)/(2*SW)}}, C[S[6], U[1], -U[3]] == 

    {{(-I)*EL*MW*$HKSign}}, C[-S[6], U[1], -U[4]] == {{(-I)*EL*MW*$HKSign}}, 

   C[S[6], U[2], -U[3]] == {{((I/2)*EL*MW*(-CW^2 + SW^2))/(CW*SW)}}, 

   C[-S[6], U[2], -U[4]] == {{((I/2)*EL*MW*(-CW^2 + SW^2))/(CW*SW)}}, 

   C[S[6], U[4], -U[2]] == {{((I/2)*EL*MW)/(CW*SW)}}, 

   C[-S[6], U[3], -U[2]] == {{((I/2)*EL*MW)/(CW*SW)}}, 
   ...
   C[S[6], -S[6], V[2], V[2]] == {{((I/2)*EL^2*(CW^2 - \
SW^2)^2)/(CW^2*SW^2)}}, 
 C[S[6], -S[6], V[3], -V[3]] == \
{{((I/2)*EL^2)/SW^2}}, 
 C[V[1], V[1], V[3], -V[3]] == {{(-2*I)*EL^2}, \
{I*EL^2}, {I*EL^2}}, 
 C[V[1], V[2], V[3], -V[3]] == \
{{((-2*I)*CW*EL^2*$HKSign)/SW}, 
   {(I*CW*EL^2*$HKSign)/SW}, \
{(I*CW*EL^2*$HKSign)/SW}}, 
 C[V[2], V[2], V[3], -V[3]] == \
{{((-2*I)*CW^2*EL^2)/SW^2}, 
   ...
   C[S[1], U[2], -U[2]] == {{((-I/2)*EL*MW*SBA)/(CW^2*SW)}}, 

   C[S[2], U[2], -U[2]] == {{((-I/2)*CBA*EL*MW)/(CW^2*SW)}}, 

   C[S[1], U[3], -U[3]] == {{((-I/2)*EL*MW*SBA)/SW}}, 

   C[S[2], U[3], -U[3]] == {{((-I/2)*CBA*EL*MW)/SW}}, 

   C[S[1], U[4], -U[4]] == {{((-I/2)*EL*MW*SBA)/SW}}, 

   C[S[2], U[4], -U[4]] == {{((-I/2)*CBA*EL*MW)/SW}}, 
 ...
 C[S[3], S[4], S[4], S[4]] == {{(((3*I)/4)*C2B*EL^2*S2B)/(CW^2*SW^2)}}, 
   ...
   C[S[5], S[6], -S[5], -S[6]] == {{((I/4)*EL^2*(C2B^2 - \
S2B^2))/(CW^2*SW^2)}}, 
 C[S[5], S[6], -S[6], -S[6]] == \
...
{{((I/2)*C2B*EL^2*S2B)/(CW^2*SW^2)}}, 
 C[S[6], S[6], -S[6], -S[6]] == \
{{((-I/2)*C2B^2*EL^2)/(CW^2*SW^2)}}, 
 C[S[1], S[5], V[1], -V[3]] == \
{{((I/2)*CBA*EL^2*$HKSign)/SW}}, 
 C[S[1], S[5], V[2], -V[3]] == \
{{((-I/2)*CBA*EL^2)/CW}}, 
 C[S[1], S[6], V[1], -V[3]] == \
{{((I/2)*EL^2*SBA*$HKSign)/SW}}, 
 C[S[1], S[6], V[2], -V[3]] == \
{{((-I/2)*EL^2*SBA)/CW}}, 
 C[S[1], -S[5], V[1], V[3]] == \
{{((I/2)*CBA*EL^2*$HKSign)/SW}}, 
...
{{-(EL^2*$HKSign)/(2*SW)}}, 
 C[S[3], S[5], V[2], -V[3]] == {{EL^2/(2*CW)}}, 
   ...
   C[S[5], -S[5], V[2], V[2]] == {{((I/2)*EL^2*(CW^2 - \
SW^2)^2)/(CW^2*SW^2)}}, 
 C[S[5], -S[5], V[3], -V[3]] == \
{{((I/2)*EL^2)/SW^2}}, 
 C[F[2, {j1}], -F[2, {j2}], S[1]] == 
   ...
   C[F[3, {j1, o1}], -F[3, {j2, o2}], S[1]] == 
    ...
    {{((-I/2)*CA*EL*IndexDelta[j1, j2]*IndexDelta[o1, o2]*Mass[F[3, {j1, \
o1}]])/
     (MW*SB*SW)}, {((-I/2)*CA*EL*IndexDelta[j1, j2]*IndexDelta[o1, \
o2]*
      Mass[F[3, {j1, o1}]])/(MW*SB*SW)}}, 

   C[F[4, {j1, o1}], -F[4, {j2, o2}], S[1]] == 

    {{((I/2)*EL*SA*IndexDelta[j1, j2]*IndexDelta[o1, o2]*Mass[F[4, {j1, \
o1}]])/
     (CB*MW*SW)}, {((I/2)*EL*SA*IndexDelta[j1, j2]*IndexDelta[o1, \
o2]*
      Mass[F[4, {j1, o1}]])/(CB*MW*SW)}}, C[F[2, {j1}], -F[2, {j2}], \
S[4]] == 
...
== 
  ...
  {{((-I/6)*EL*(-3 + 2*SW^2)*$HKSign*IndexDelta[j1, j2]*IndexDelta[o1, o2])/
       ...
       (CW*SW)}, {((-I/3)*EL*SW*$HKSign*IndexDelta[j1, j2]*IndexDelta[o1, \
o2])/
   ...
   C[F[3, {j1, o1}], -F[3, {j2, o2}], S[2]] == 
    ...
    {{((-I/2)*EL*SA*IndexDelta[j1, j2]*IndexDelta[o1, o2]*Mass[F[3, {j1, \
o1}]])/
     (MW*SB*SW)}, {((-I/2)*EL*SA*IndexDelta[j1, j2]*IndexDelta[o1, \
o2]*
      Mass[F[3, {j1, o1}]])/(MW*SB*SW)}}, 

   C[F[4, {j1, o1}], -F[4, {j2, o2}], S[2]] == 

    {{((-I/2)*CA*EL*IndexDelta[j1, j2]*IndexDelta[o1, o2]*Mass[F[4, {j1, \
o1}]])/
     (CB*MW*SW)}, {((-I/2)*CA*EL*IndexDelta[j1, j2]*IndexDelta[o1, \
o2]*
      Mass[F[4, {j1, o1}]])/(CB*MW*SW)}}, C[F[2, {j1}], -F[2, {j2}], \
S[3]] == 
...
o1}]])/
     (Sqrt[2]*MW*SW)}, {(I*EL*Conjugate[CKM[j1, j2]]*IndexDelta[o1, \
o2]*
   ...
   C[F[3, {j1, o1}], -F[4, {j2, o2}], S[5]] == 
    ...
    {{(I*EL*TB*Conjugate[CKM[j1, j2]]*IndexDelta[o1, o2]*Mass[F[4, {j2, \
o1}]])/
     (Sqrt[2]*MW*SW)}, {(I*EL*Conjugate[CKM[j1, j2]]*IndexDelta[o1, \
o2]*
   ...
   C[S[3], S[12, {s1, j1}], -S[12, {s2, j2}]] == 
    ...
    {{-(EL*IndexDelta[j1, j2]*Mass[F[2, {j1}]]*((MUE + TB*Conjugate[Af[2, \
j1]])*
         Conjugate[USf[2, j1][s1, 2]]*USf[2, j1][s2, 1] - 

          (TB*Af[2, j1] + Conjugate[MUE])*Conjugate[USf[2, j1][s1, 1]]*

           USf[2, j1][s2, 2]))/(2*MW*SW)}}, 
...
j1]])*
         Conjugate[USf[2, j1][s1, 2]]*USf[2, j1][s2, 1] + 
          ...
          (Af[2, j1] - TB*Conjugate[MUE])*Conjugate[USf[2, j1][s1, 1]]*
   ...
   C[S[3], S[13, {s1, j1, o1}], -S[13, {s2, j2, o2}]] == 
    ...
    {{-(EL*IndexDelta[j1, j2]*IndexDelta[o1, o2]*Mass[F[3, {j1}]]*
         ...
         ((MUE*TB + Conjugate[Af[3, j1]])*Conjugate[USf[3, j1][s1, 2]]*

           USf[3, j1][s2, 1] - (Af[3, j1] + TB*Conjugate[MUE])*
   ...
   C[S[4], S[13, {s1, j1, o1}], -S[13, {s2, j2, o2}]] == 
    ...
    {{(EL*IndexDelta[j1, j2]*IndexDelta[o1, o2]*Mass[F[3, {j1}]]*
        ...
        ((MUE - TB*Conjugate[Af[3, j1]])*Conjugate[USf[3, j1][s1, 2]]*
          ...
          USf[3, j1][s2, 1] + (TB*Af[3, j1] - Conjugate[MUE])*
   ...
   C[S[3], S[14, {s1, j1, o1}], -S[14, {s2, j2, o2}]] == 
    ...
    {{-(EL*IndexDelta[j1, j2]*IndexDelta[o1, o2]*Mass[F[4, {j1}]]*
         ...
         ((MUE + TB*Conjugate[Af[4, j1]])*Conjugate[USf[4, j1][s1, 2]]*

           USf[4, j1][s2, 1] - (TB*Af[4, j1] + Conjugate[MUE])*
   ...
   C[S[4], S[14, {s1, j1, o1}], -S[14, {s2, j2, o2}]] == 
    ...
    {{-(EL*IndexDelta[j1, j2]*IndexDelta[o1, o2]*Mass[F[4, {j1}]]*
         ...
         ((MUE*TB - Conjugate[Af[4, j1]])*Conjugate[USf[4, j1][s1, 2]]*
           ...
           USf[4, j1][s2, 1] + (Af[4, j1] - TB*Conjugate[MUE])*
   ...
   C[S[1], S[12, {s1, j1}], -S[12, {s2, j2}]] == 
    ...
    {{((I/2)*EL*IndexDelta[j1, j2]*(Conjugate[USf[2, j1][s1, 1]]*
          ...
          ((CB*MW*MZ*SAB*(-1 + 2*SW^2) + 2*CW*SA*Mass[F[2, {j1}]]^2)*
            ...
            USf[2, j1][s2, 1] + CW*(SA*Af[2, j1] + CA*Conjugate[MUE])*

            Mass[F[2, {j1}]]*USf[2, j1][s2, 2]) + Conjugate[USf[2, j1][s1, \
2]]*
        (CW*(CA*MUE + SA*Conjugate[Af[2, j1]])*Mass[F[2, {j1}]]*
   ...
   C[S[2], S[12, {s1, j1}], -S[12, {s2, j2}]] == 
    ...
    {{((I/2)*EL*IndexDelta[j1, j2]*(Conjugate[USf[2, j1][s1, 1]]*
          ...
          ((CAB*CB*MW*MZ*(1 - 2*SW^2) - 2*CA*CW*Mass[F[2, {j1}]]^2)*
            ...
            USf[2, j1][s2, 1] + CW*(-(CA*Af[2, j1]) + SA*Conjugate[MUE])*

            Mass[F[2, {j1}]]*USf[2, j1][s2, 2]) + Conjugate[USf[2, j1][s1, \
2]]*
        (CW*(MUE*SA - CA*Conjugate[Af[2, j1]])*Mass[F[2, {j1}]]*
   ...
   C[S[2], S[13, {s1, j1, o1}], -S[13, {s2, j2, o2}]] == 
    ...
    {{((-I/6)*EL*IndexDelta[j1, j2]*IndexDelta[o1, o2]*
        ...
        (Conjugate[USf[3, j1][s1, 1]]*((CAB*MW*MZ*SB*(3 - 4*SW^2) + 
           ...
           3*CW*(SA*Af[3, j1] - CA*Conjugate[MUE])*Mass[F[3, {j1}]]*

            USf[3, j1][s2, 2]) + Conjugate[USf[3, j1][s1, 2]]*

          (3*CW*(-(CA*MUE) + SA*Conjugate[Af[3, j1]])*Mass[F[3, {j1}]]*
   ...
   C[S[2], S[14, {s1, j1, o1}], -S[14, {s2, j2, o2}]] == 
    ...
    {{((-I/6)*EL*IndexDelta[j1, j2]*IndexDelta[o1, o2]*
        ...
        (Conjugate[USf[4, j1][s1, 1]]*((CAB*CB*MW*MZ*(-3 + 2*SW^2) + 
           ...
           3*CW*(CA*Af[4, j1] - SA*Conjugate[MUE])*Mass[F[4, {j1}]]*

            USf[4, j1][s2, 2]) + Conjugate[USf[4, j1][s1, 2]]*

          (3*CW*(-(MUE*SA) + CA*Conjugate[Af[4, j1]])*Mass[F[4, {j1}]]*
   ...
   C[-S[5], S[14, {s2, j2, o1}], -S[13, {s1, j1, o2}]] == 
    ...
    {{((-I)*EL*CKM[j1, j2]*IndexDelta[o1, o2]*
        ...
        (-(Conjugate[USf[4, j2][s2, 2]]*Mass[F[4, {j2}]]*
           ...
           (TB*(MUE + TB*Conjugate[Af[4, j1]])*USf[3, j1][s1, 1] + 
         ...
         Conjugate[USf[4, j2][s2, 1]]*
          ...
          (-((Mass[F[3, {j1}]]^2 + TB*(-(MW^2*S2B) + TB*Mass[F[4, {j2}]]^2))*
             ...
             USf[3, j1][s1, 1]) - (Af[3, j1] + TB*Conjugate[MUE])*
   ...
   C[S[5], S[13, {s1, j1, o1}], -S[14, {s2, j2, o2}]] == 
    ...
    {{((-I)*EL*Conjugate[CKM[j1, j2]]*IndexDelta[o1, o2]*
        ...
        (-(Conjugate[USf[3, j1][s1, 2]]*Mass[F[3, {j1}]]*
           ...
           ((MUE*TB + Conjugate[Af[3, j1]])*USf[4, j2][s2, 1] + 
         ...
         Conjugate[USf[3, j1][s1, 1]]*
          ...
          (-((Mass[F[3, {j1}]]^2 + TB*(-(MW^2*S2B) + TB*Mass[F[4, {j2}]]^2))*
             ...
             USf[4, j2][s2, 1]) - TB*(TB*Af[4, j1] + Conjugate[MUE])*

            Mass[F[4, {j2}]]*USf[4, j2][s2, 2])))/(Sqrt[2]*MW*SW*TB)}}, 

   C[-S[5], S[12, {s2, j2}], -S[11, {j1}]] == 

    {{((-I)*EL*IndexDelta[j1, j2]*(-((MUE + TB*Conjugate[Af[2, j1]])*
    ...
    {{((-I)*EL*IndexDelta[j1, j2]*((MW^2*S2B - TB*Mass[F[2, {j1}]]^2)*
          ...
          USf[2, j1][s2, 1] - (TB*Af[2, j1] + Conjugate[MUE])*Mass[F[2, \
{j1}]]*
        USf[2, j1][s2, 2]))/(Sqrt[2]*MW*SW)}}, 

   C[-S[6], S[14, {s2, j2, o1}], -S[13, {s1, j1, o2}]] == 

    {{(I*EL*CKM[j1, j2]*IndexDelta[o1, o2]*(TB*(MUE*TB - Conjugate[Af[4, \
j1]])*
        Conjugate[USf[4, j2][s2, 2]]*Mass[F[4, {j2}]]*USf[3, j1][s1, \
1] + 
       Conjugate[USf[4, j2][s2, 1]]*(TB*(C2B*MW^2 + Mass[F[3, {j1}]]^2 \
- 
           Mass[F[4, {j2}]]^2)*USf[3, j1][s1, 1] + 

           (TB*Af[3, j1] - Conjugate[MUE])*Mass[F[3, {j1}]]*

            USf[3, j1][s1, 2])))/(Sqrt[2]*MW*SW*TB)}}, 
   ...
   C[S[6], S[13, {s1, j1, o1}], -S[14, {s2, j2, o2}]] == 
    ...
    {{(I*EL*Conjugate[CKM[j1, j2]]*IndexDelta[o1, o2]*
        ...
        ((-MUE + TB*Conjugate[Af[3, j1]])*Conjugate[USf[3, j1][s1, 2]]*
          ...
          Mass[F[3, {j1}]]*USf[4, j2][s2, 1] + TB*Conjugate[USf[3, j1][s1, \
1]]*
        ((C2B*MW^2 + Mass[F[3, {j1}]]^2 - Mass[F[4, {j2}]]^2)*

            USf[4, j2][s2, 1] + (-Af[4, j1] + TB*Conjugate[MUE])*
   ...
   C[-S[6], S[12, {s2, j2}], -S[11, {j1}]] == 
    ...
    {{(I*EL*IndexDelta[j1, j2]*((C2B*MW^2 - Mass[F[2, {j1}]]^2)*
          ...
          USf[2, j1][s2, 1] + (-Af[2, j1] + TB*Conjugate[MUE])*Mass[F[2, \
{j1}]]*
        USf[2, j1][s2, 2]))/(Sqrt[2]*MW*SW)}}, 
   ...
   C[S[13, {s1, j1, o1}], -S[13, {s2, j2, o2}], V[1]] == 
    ...
    {{((-2*I)/3)*EL*IndexDelta[j1, j2]*IndexDelta[o1, o2]*IndexDelta[s1, \
s2]}}, 
 C[S[13, {s1, j1, o1}], -S[13, {s2, j2, o2}], V[2]] == 
   ...
   C[S[12, {s2, j2}], -S[11, {j1}], -V[3]] == 
    ...
    {{((-I)*EL*$HKSign*Conjugate[USf[2, j1][s2, 1]]*IndexDelta[j1, j2])/
       ...
       (Sqrt[2]*SW)}}, C[F[11, {c2}], F[11, {c1}], S[1]] == 

    {{((-I/2)*EL*$HKSign*(SA*Conjugate[ZNeu[c1, 3]]*

          (SW*Conjugate[ZNeu[c2, 1]] - CW*Conjugate[ZNeu[c2, 2]]) + 

         CA*Conjugate[ZNeu[c1, 4]]*(SW*Conjugate[ZNeu[c2, 1]] - 

           CW*Conjugate[ZNeu[c2, 2]]) + (SW*Conjugate[ZNeu[c1, 1]] - 

           CW*Conjugate[ZNeu[c1, 2]])*(SA*Conjugate[ZNeu[c2, 3]] + 

           CA*Conjugate[ZNeu[c2, 4]])))/(CW*SW)}, 

     {((I/2)*EL*$HKSign*(ZNeu[c1, 4]*(-(CA*SW*ZNeu[c2, 1]) + 

           CA*CW*ZNeu[c2, 2]) + ZNeu[c1, 3]*(-(SA*SW*ZNeu[c2, 1]) + 

           CW*SA*ZNeu[c2, 2]) - (SW*ZNeu[c1, 1] - CW*ZNeu[c1, 2])*

          (SA*ZNeu[c2, 3] + CA*ZNeu[c2, 4])))/(CW*SW)}}, 

   C[F[11, {c2}], F[11, {c1}], S[2]] == 

    {{((I/2)*EL*$HKSign*(CA*Conjugate[ZNeu[c1, 3]]*(SW*Conjugate[ZNeu[c2, 1]] \
- 
         CW*Conjugate[ZNeu[c2, 2]]) + Conjugate[ZNeu[c1, 4]]*

          (-(SA*SW*Conjugate[ZNeu[c2, 1]]) + CW*SA*Conjugate[ZNeu[c2, 2]]) + 

         (SW*Conjugate[ZNeu[c1, 1]] - CW*Conjugate[ZNeu[c1, 2]])*

          (CA*Conjugate[ZNeu[c2, 3]] - SA*Conjugate[ZNeu[c2, 4]])))/(CW*SW)}, \

   {((I/2)*EL*$HKSign*(CA*ZNeu[c1, 3]*(SW*ZNeu[c2, 1] - CW*ZNeu[c2, 2]) + 

         ZNeu[c1, 4]*(-(SA*SW*ZNeu[c2, 1]) + CW*SA*ZNeu[c2, 2]) + 

         (SW*ZNeu[c1, 1] - CW*ZNeu[c1, 2])*(CA*ZNeu[c2, 3] - SA*ZNeu[c2, \
4])))/
     (CW*SW)}}, C[F[11, {c2}], F[11, {c1}], S[3]] == 

    {{(EL*$HKSign*(SB*Conjugate[ZNeu[c1, 3]]*(SW*Conjugate[ZNeu[c2, 1]] - 

           CW*Conjugate[ZNeu[c2, 2]]) + Conjugate[ZNeu[c1, 4]]*

          (-(CB*SW*Conjugate[ZNeu[c2, 1]]) + CB*CW*Conjugate[ZNeu[c2, 2]]) + 

         (SW*Conjugate[ZNeu[c1, 1]] - CW*Conjugate[ZNeu[c1, 2]])*

          (SB*Conjugate[ZNeu[c2, 3]] - CB*Conjugate[ZNeu[c2, \
4]])))/(2*CW*SW)}, 
   {-(EL*$HKSign*(SB*ZNeu[c1, 3]*(SW*ZNeu[c2, 1] - \
CW*ZNeu[c2, 2]) + 
        ZNeu[c1, 4]*(-(CB*SW*ZNeu[c2, 1]) + CB*CW*ZNeu[c2, \
2]) + 
        (SW*ZNeu[c1, 1] - CW*ZNeu[c1, 2])*(SB*ZNeu[c2, 3] - \
CB*ZNeu[c2, 4])))/
     (2*CW*SW)}}, C[F[11, {c2}], F[11, {c1}], S[4]] == 

    {{-(EL*$HKSign*(CB*Conjugate[ZNeu[c1, 3]]*(SW*Conjugate[ZNeu[c2, 1]] - 

            CW*Conjugate[ZNeu[c2, 2]]) + SB*Conjugate[ZNeu[c1, 4]]*

           (SW*Conjugate[ZNeu[c2, 1]] - CW*Conjugate[ZNeu[c2, 2]]) + 

          (SW*Conjugate[ZNeu[c1, 1]] - CW*Conjugate[ZNeu[c1, 2]])*

           (CB*Conjugate[ZNeu[c2, 3]] + SB*Conjugate[ZNeu[c2, 4]])))/

       (2*CW*SW)}, 

     {(EL*$HKSign*(CB*ZNeu[c1, 3]*(SW*ZNeu[c2, 1] - CW*ZNeu[c2, 2]) + 

         SB*ZNeu[c1, 4]*(SW*ZNeu[c2, 1] - CW*ZNeu[c2, 2]) + 

         (SW*ZNeu[c1, 1] - CW*ZNeu[c1, 2])*(CB*ZNeu[c2, 3] + SB*ZNeu[c2, \
4])))/
    ...
    {{(EL*(CB*Conjugate[UCha[c1, 2]]*Conjugate[VCha[c2, 1]] - 
     ...
     {(EL*(-(CB*UCha[c2, 2]*VCha[c1, 1]) + SB*UCha[c2, 1]*VCha[c1, 2]))/
       ...
       (Sqrt[2]*SW)}}, C[F[11, {c1}], -F[12, {c2}], S[5]] == 

    {{((-I)*CB*EL*$HKSign*((Conjugate[VCha[c2, 2]]*

           ((SW*Conjugate[ZNeu[c1, 1]])/CW + Conjugate[ZNeu[c1, 2]]))/Sqrt[2] \
+ 
       Conjugate[VCha[c2, 1]]*Conjugate[ZNeu[c1, 4]]))/SW}, 

     {((-I)*EL*SB*$HKSign*(-((UCha[c2, 2]*((SW*ZNeu[c1, 1])/CW + ZNeu[c1, \
2]))/
         Sqrt[2]) + UCha[c2, 1]*ZNeu[c1, 3]))/SW}}, 

   C[F[11, {c1}], -F[12, {c2}], S[6]] == 
...
+ 
     ...
     {(I*CB*EL*$HKSign*(-((UCha[c2, 2]*((SW*ZNeu[c1, 1])/CW + ZNeu[c1, 2]))/

           Sqrt[2]) + UCha[c2, 1]*ZNeu[c1, 3]))/SW}}, 

   C[F[12, {c2}], F[11, {c1}], -S[5]] == 

    {{((-I)*EL*SB*$HKSign*(-((Conjugate[UCha[c2, 2]]*

            ((SW*Conjugate[ZNeu[c1, 1]])/CW + Conjugate[ZNeu[c1, 2]]))/

           Sqrt[2]) + Conjugate[UCha[c2, 1]]*Conjugate[ZNeu[c1, 3]]))/SW}, 

     {((-I)*CB*EL*$HKSign*((VCha[c2, 2]*((SW*ZNeu[c1, 1])/CW + ZNeu[c1, 2]))/

          Sqrt[2] + VCha[c2, 1]*ZNeu[c1, 4]))/SW}}, 

   C[F[12, {c2}], F[11, {c1}], -S[6]] == 

    {{(I*CB*EL*$HKSign*(-((Conjugate[UCha[c2, 2]]*((SW*Conjugate[ZNeu[c1, \
1]])/
            CW + Conjugate[ZNeu[c1, 2]]))/Sqrt[2]) + Conjugate[UCha[c2, \
1]]*
        Conjugate[ZNeu[c1, 3]]))/SW}, 

     {((-I)*EL*SB*$HKSign*((VCha[c2, 2]*((SW*ZNeu[c1, 1])/CW + ZNeu[c1, 2]))/

          Sqrt[2] + VCha[c2, 1]*ZNeu[c1, 4]))/SW}}, 

   C[F[11, {c1}], -F[1, {j1}], S[11, {j2}]] == 

    {{0}, {(I*EL*$HKSign*IndexDelta[j1, j2]*(SW*ZNeu[c1, 1] - CW*ZNeu[c1, \
2]))/
     (Sqrt[2]*CW*SW)}}, C[F[11, {c1}], -F[2, {j1}], S[12, {s2, j2}]] == \

  {{((-I)*EL*$HKSign*IndexDelta[j1, j2]*(2*CB*MW*SW*Conjugate[ZNeu[c1, 1]]*

          Conjugate[USf[2, j1][s2, 2]] + CW*Conjugate[ZNeu[c1, 3]]*
     ...
     {(I*EL*$HKSign*IndexDelta[j1, j2]*(CB*MW*Conjugate[USf[2, j1][s2, 1]]*
          ...
          (SW*ZNeu[c1, 1] + CW*ZNeu[c1, 2]) - CW*Conjugate[USf[2, j1][s2, \
2]]*
        Mass[F[2, {j1}]]*ZNeu[c1, 3]))/(Sqrt[2]*CB*CW*MW*SW)}}, 

   C[F[11, {c1}], -F[3, {j1, o1}], S[13, {s2, j2, o2}]] == 

    {{((I/3)*EL*$HKSign*IndexDelta[j1, j2]*IndexDelta[o1, o2]*

        (4*MW*SB*SW*Conjugate[ZNeu[c1, 1]]*Conjugate[USf[3, j1][s2, 2]] - 

         3*CW*Conjugate[ZNeu[c1, 4]]*Conjugate[USf[3, j1][s2, 1]]*

          Mass[F[3, {j1, o1}]]))/(Sqrt[2]*CW*MW*SB*SW)}, 

     {((-I/3)*EL*$HKSign*IndexDelta[j1, j2]*IndexDelta[o1, o2]*

        (MW*SB*Conjugate[USf[3, j1][s2, 1]]*(SW*ZNeu[c1, 1] + 

           3*CW*ZNeu[c1, 2]) + 3*CW*Conjugate[USf[3, j1][s2, 2]]*

          Mass[F[3, {j1, o1}]]*ZNeu[c1, 4]))/(Sqrt[2]*CW*MW*SB*SW)}}, 

   C[F[11, {c1}], -F[4, {j1, o1}], S[14, {s2, j2, o2}]] == 

    {{((-I/3)*EL*$HKSign*IndexDelta[j1, j2]*IndexDelta[o1, o2]*

        (2*CB*MW*SW*Conjugate[ZNeu[c1, 1]]*Conjugate[USf[4, j1][s2, 2]] + 

         3*CW*Conjugate[ZNeu[c1, 3]]*Conjugate[USf[4, j1][s2, 1]]*

          Mass[F[4, {j1, o1}]]))/(Sqrt[2]*CB*CW*MW*SW)}, 

     {((I/3)*EL*$HKSign*IndexDelta[j1, j2]*IndexDelta[o1, o2]*

        (CB*MW*Conjugate[USf[4, j1][s2, 1]]*(-(SW*ZNeu[c1, 1]) + 

           3*CW*ZNeu[c1, 2]) - 3*CW*Conjugate[USf[4, j1][s2, 2]]*

          Mass[F[4, {j1, o1}]]*ZNeu[c1, 3]))/(Sqrt[2]*CB*CW*MW*SW)}}, 

   C[F[1, {j1}], F[11, {c1}], -S[11, {j2}]] == 

    {{(I*EL*$HKSign*(SW*Conjugate[ZNeu[c1, 1]] - CW*Conjugate[ZNeu[c1, 2]])*

        IndexDelta[j1, j2])/(Sqrt[2]*CW*SW)}, {0}}, 

   C[F[2, {j1}], F[11, {c1}], -S[12, {s2, j2}]] == 

    {{(I*EL*$HKSign*IndexDelta[j1, j2]*(CB*MW*SW*Conjugate[ZNeu[c1, 1]]*

          USf[2, j1][s2, 1] + CW*(CB*MW*Conjugate[ZNeu[c1, 2]]*

            USf[2, j1][s2, 1] - Conjugate[ZNeu[c1, 3]]*Mass[F[2, {j1}]]*

            USf[2, j1][s2, 2])))/(Sqrt[2]*CB*CW*MW*SW)}, 

     {((-I)*EL*$HKSign*IndexDelta[j1, j2]*(CW*Mass[F[2, {j1}]]*ZNeu[c1, 3]*

          USf[2, j1][s2, 1] + 2*CB*MW*SW*ZNeu[c1, 1]*USf[2, j1][s2, 2]))/

       (Sqrt[2]*CB*CW*MW*SW)}}, C[F[3, {j1, o1}], F[11, {c1}], 

     -S[13, {s2, j2, o2}]] == 

    {{((-I/3)*EL*$HKSign*IndexDelta[j1, j2]*IndexDelta[o1, o2]*

        (MW*SB*SW*Conjugate[ZNeu[c1, 1]]*USf[3, j1][s2, 1] + 

         3*CW*(MW*SB*Conjugate[ZNeu[c1, 2]]*USf[3, j1][s2, 1] + 

           Conjugate[ZNeu[c1, 4]]*Mass[F[3, {j1, o1}]]*USf[3, j1][s2, 2])))/

       (Sqrt[2]*CW*MW*SB*SW)}, {((I/3)*EL*$HKSign*IndexDelta[j1, j2]*

        IndexDelta[o1, o2]*(-3*CW*Mass[F[3, {j1, o1}]]*ZNeu[c1, 4]*

          USf[3, j1][s2, 1] + 4*MW*SB*SW*ZNeu[c1, 1]*USf[3, j1][s2, 2]))/

       (Sqrt[2]*CW*MW*SB*SW)}}, C[F[4, {j1, o1}], F[11, {c1}], 

     -S[14, {s2, j2, o2}]] == 

    {{((I/3)*EL*$HKSign*IndexDelta[j1, j2]*IndexDelta[o1, o2]*

        (-(CB*MW*SW*Conjugate[ZNeu[c1, 1]]*USf[4, j1][s2, 1]) + 

         3*CW*(CB*MW*Conjugate[ZNeu[c1, 2]]*USf[4, j1][s2, 1] - 

           Conjugate[ZNeu[c1, 3]]*Mass[F[4, {j1, o1}]]*USf[4, j1][s2, 2])))/

       (Sqrt[2]*CB*CW*MW*SW)}, {((-I/3)*EL*$HKSign*IndexDelta[j1, j2]*

        IndexDelta[o1, o2]*(3*CW*Mass[F[4, {j1, o1}]]*ZNeu[c1, 3]*

          USf[4, j1][s2, 1] + 2*CB*MW*SW*ZNeu[c1, 1]*USf[4, j1][s2, 2]))/
    ...
    {{(I*EL*$HKSign*Conjugate[CKM[j1, j2]]*Conjugate[UCha[c1, 2]]*
        ...
        Conjugate[USf[3, j1][s1, 1]]*IndexDelta[o1, o2]*Mass[F[4, {j2, \
o1}]])/
     (Sqrt[2]*CB*MW*SW)}, {((-I/2)*EL*$HKSign*Conjugate[CKM[j1, j2]]*

        IndexDelta[o1, o2]*(2*MW*SB*Conjugate[USf[3, j1][s1, 1]]*VCha[c1, 1] \
- 
       Sqrt[2]*Conjugate[USf[3, j1][s1, 2]]*Mass[F[3, {j1}]]*VCha[c1, \
2]))/
     (MW*SB*SW)}}, C[-F[12, {c1}], -F[3, {j1, o1}], S[14, {s2, j2, \
o2}]] == 
  {{(I*EL*$HKSign*CKM[j1, j2]*Conjugate[VCha[c1, 2]]*

        Conjugate[USf[4, j2][s2, 1]]*IndexDelta[o1, o2]*Mass[F[3, {j1, \
o1}]])/
     (Sqrt[2]*MW*SB*SW)}, {((-I/2)*EL*$HKSign*CKM[j1, \
j2]*IndexDelta[o1, o2]*
      (2*CB*MW*Conjugate[USf[4, j2][s2, 1]]*UCha[c1, \
1] - 
       Sqrt[2]*Conjugate[USf[4, j2][s2, 2]]*Mass[F[4, {j2}]]*UCha[c1, \
2]))/
     (CB*MW*SW)}}, C[F[12, {c1}], -F[2, {j2}], S[11, {j1}]] == 

    {{(I*EL*$HKSign*Conjugate[UCha[c1, 2]]*IndexDelta[j1, j2]*Mass[F[2, \
{j1}]])/
     (Sqrt[2]*CB*MW*SW)}, {((-I)*EL*$HKSign*IndexDelta[j1, \
j2]*VCha[c1, 1])/
  ...
  {{0}, {((I/2)*EL*$HKSign*IndexDelta[j1, j2]*
    ...
    {{((I/2)*EL*$HKSign*IndexDelta[j1, j2]*(-2*Conjugate[UCha[c1, 1]]*
          ...
          USf[2, j1][s2, 1] + (Sqrt[2]*Conjugate[UCha[c1, 2]]*Mass[F[2, \
{j1}]]*
         USf[2, j1][s2, 2])/(CB*MW)))/SW}, {0}}, 

   C[F[11, {c1}], F[11, {c2}], V[2]] == 

    {{((I/2)*EL*$HKSign*(-(Conjugate[ZNeu[c2, 3]]*ZNeu[c1, 3]) + 

         Conjugate[ZNeu[c2, 4]]*ZNeu[c1, 4]))/(CW*SW)}, 

     {((I/2)*EL*$HKSign*(Conjugate[ZNeu[c1, 3]]*ZNeu[c2, 3] - 

         Conjugate[ZNeu[c1, 4]]*ZNeu[c2, 4]))/(CW*SW)}}, 

   C[F[11, {c2}], -F[12, {c1}], V[3]] == 

    {{(I*EL*$HKSign*(Conjugate[VCha[c1, 1]]*ZNeu[c2, 2] - 

         (Conjugate[VCha[c1, 2]]*ZNeu[c2, 4])/Sqrt[2]))/SW}, 

     {(I*EL*$HKSign*(Conjugate[ZNeu[c2, 2]]*UCha[c1, 1] + 

         (Conjugate[ZNeu[c2, 3]]*UCha[c1, 2])/Sqrt[2]))/SW}}, 

   C[F[12, {c1}], F[11, {c2}], -V[3]] == 

    {{(I*EL*$HKSign*(Conjugate[ZNeu[c2, 2]]*VCha[c1, 1] - 

         (Conjugate[ZNeu[c2, 4]]*VCha[c1, 2])/Sqrt[2]))/SW}, 

     {(I*EL*$HKSign*(Conjugate[UCha[c1, 1]]*ZNeu[c2, 2] + 

         (Conjugate[UCha[c1, 2]]*ZNeu[c2, 3])/Sqrt[2]))/SW}}, 
   ...
   C[S[3], S[4], S[12, {s2, j2}], -S[12, {s1, j1}]] == 
    ...
    {{((-I/2)*EL^2*Conjugate[CKM[j1, j2]]*IndexDelta[o1, o2]*
       ...
       2*SB^2*SBA*Conjugate[USf[3, j1][s1, 2]]*Mass[F[3, {j1}]]*
          ...
          Mass[F[4, {j2}]]*USf[4, j2][s2, \
2]))/(Sqrt[2]*MW^2*S2B*SB^2*SW^2)}}, 
 C[S[1], -S[5], S[14, {s2, j2, o1}], \
-S[13, {s1, j1, o2}]] == 
  {{((-I/2)*EL^2*CKM[j1, j2]*IndexDelta[o1, o2]*
       ...
       2*SB^2*SBA*Conjugate[USf[4, j2][s2, 2]]*Mass[F[3, {j1}]]*
          ...
          Mass[F[4, {j2}]]*USf[3, j1][s1, \
2]))/(Sqrt[2]*MW^2*S2B*SB^2*SW^2)}}, 
 C[S[1], S[6], S[13, {s1, j1, o1}], \
-S[14, {s2, j2, o2}]] == 
  {{((-I/2)*EL^2*Conjugate[CKM[j1, \
j2]]*IndexDelta[o1, o2]*
      (S2B*Conjugate[USf[3, j1][s1, \
1]]*(CB*MW^2*SAB*SB - 
         CA*CB*Mass[F[3, {j1}]]^2 - SA*SB*Mass[F[4, \
{j2}]]^2)*
        USf[4, j2][s2, 1] + 2*CB*CBA*SB*Conjugate[USf[3, j1][s1, \
2]]*
   ...
   C[S[3], S[5], S[13, {s1, j1, o1}], -S[14, {s2, j2, o2}]] == 
    ...
    {{(EL^2*Conjugate[CKM[j1, j2]]*Conjugate[USf[3, j1][s1, 1]]*
        ...
        IndexDelta[o1, o2]*(C2B - Mass[F[3, {j1}]]^2/(MW^2*TB^2) + 
         ...
         (TB^2*Mass[F[4, {j2}]]^2)/MW^2)*USf[4, j2][s2, \
1])/(2*Sqrt[2]*SW^2)}}, 
 C[S[3], -S[5], S[14, {s2, j2, o1}], -S[13, {s1, j1, \
o2}]] == 
  {{-(EL^2*CKM[j1, j2]*Conjugate[USf[4, j2][s2, 1]]*IndexDelta[o1, \
o2]*
       (C2B - Mass[F[3, {j1}]]^2/(MW^2*TB^2) + (TB^2*Mass[F[4, \
{j2}]]^2)/
   ...
   C[S[3], -S[6], S[14, {s2, j2, o1}], -S[13, {s1, j1, o2}]] == 
    ...
    {{-(EL^2*CKM[j1, j2]*IndexDelta[o1, o2]*(S2B*Conjugate[USf[4, j2][s2, \
1]]*
         (-Mass[F[3, {j1}]]^2 + TB*(MW^2*S2B - TB*Mass[F[4, {j2}]]^2))*
   ...
   C[S[1], S[6], S[11, {j1}], -S[12, {s2, j2}]] == 
    ...
    {{((-I/2)*EL^2*IndexDelta[j1, j2]*(SAB - (SA*Mass[F[2, \
{j1}]]^2)/(CB*MW^2))*
...
1]]*
   ...
   C[S[4], -S[6], S[14, {s2, j2, o1}], -S[13, {s1, j1, o2}]] == 
    ...
    {{(EL^2*CKM[j1, j2]*Conjugate[USf[4, j2][s2, 1]]*IndexDelta[o1, o2]*
        ...
        (C2B*MW^2 + Mass[F[3, {j1}]]^2 - Mass[F[4, {j2}]]^2)*USf[3, j1][s1, \
1])/
     (2*Sqrt[2]*MW^2*SW^2)}}, C[S[2], S[5], S[11, {j1}], -S[12, {s2, \
j2}]] == 
  {{((-I/2)*EL^2*IndexDelta[j1, j2]*(SAB - (CA*TB*Mass[F[2, \
{j1}]]^2)/
        (CB*MW^2))*USf[2, j1][s2, 1])/(Sqrt[2]*SW^2)}}, 
   ...
   C[S[5], -S[5], S[13, {s1, j1, o1}], -S[13, {s2, j2, o2}]] == 
    ...
    {{((-I/12)*EL^2*IndexDelta[o1, o2]*(TB*Conjugate[USf[3, j1][s1, 1]]*
         ...
         2*Conjugate[USf[3, j1][s1, 2]]*IndexDelta[j1, j2]*
          ...
          (-2*MW^2*S2B*SW^2*TB + 3*CW^2*Mass[F[3, {j1}]]^2)*USf[3, j2][s2, \
2]))/
...
2]))/
    ...
    {{((I/12)*EL^2*IndexDelta[o1, o2]*(Conjugate[USf[4, j1][s1, 1]]*
         ...
         2*TB^2*Conjugate[USf[4, j1][s1, 2]]*IndexDelta[j1, j2]*
          ...
          (C2B*MW^2*SW^2 + 3*CW^2*TB^2*Mass[F[4, {j1}]]^2)*USf[4, j2][s2, \
2]))/
    ...
    {{((I/12)*EL^2*IndexDelta[o1, o2]*(Conjugate[USf[4, j1][s1, 1]]*
         ...
         2*TB*Conjugate[USf[4, j1][s1, 2]]*IndexDelta[j1, j2]*
          ...
          (-(MW^2*S2B*SW^2) + 3*CW^2*TB*Mass[F[4, {j1}]]^2)*USf[4, j2][s2, \
2]))/
   ...
   C[S[12, {s1, j1}], -S[12, {s2, j2}], V[2], V[2]] == 
    ...
    {{((I/2)*EL^2*IndexDelta[j1, j2]*
        ...
        ((1 - 2*SW^2)^2*Conjugate[USf[2, j1][s1, 1]]*USf[2, j1][s2, 1] + 
         ...
         4*SW^4*Conjugate[USf[2, j1][s1, 2]]*USf[2, j1][s2, \
2]))/(CW^2*SW^2)}}, 
 C[S[13, {s1, j1, o1}], -S[13, {s2, j2, o2}], V[1], \
V[1]] == 
  {{((8*I)/9)*EL^2*IndexDelta[j1, j2]*IndexDelta[o1, o2]*

       IndexDelta[s1, s2]}}, C[S[13, {s1, j1, o1}], -S[13, {s2, j2, o2}], \
V[1], 
   V[2]] == {{(((-2*I)/9)*EL^2*$HKSign*IndexDelta[j1, \
j2]*IndexDelta[o1, o2]*
      ((-3 + 4*SW^2)*Conjugate[USf[3, j1][s1, \
1]]*USf[3, j1][s2, 1] + 
       4*SW^2*Conjugate[USf[3, j1][s1, 2]]*USf[3, \
j1][s2, 2]))/(CW*SW)}}, 
 C[S[13, {s1, j1, o1}], -S[13, {s2, j2, o2}], V[2], \
V[2]] == 
  {{((I/18)*EL^2*IndexDelta[j1, j2]*IndexDelta[o1, o2]*
     ...
     V[1]] == {{((2*I)/9)*EL^2*IndexDelta[j1, j2]*IndexDelta[o1, o2]*
       ...
       IndexDelta[s1, s2]}}, C[S[14, {s1, j1, o1}], -S[14, {s2, j2, o2}], \
V[1], 
   V[2]] == {{((-I/9)*EL^2*$HKSign*IndexDelta[j1, j2]*IndexDelta[o1, \
o2]*
      ((-3 + 2*SW^2)*Conjugate[USf[4, j1][s1, 1]]*USf[4, j1][s2, 1] + 
   ...
   C[S[14, {s1, j1, o1}], -S[14, {s2, j2, o2}], V[2], V[2]] == 
    ...
    {{((I/18)*EL^2*IndexDelta[j1, j2]*IndexDelta[o1, o2]*
        ...
        ((3 - 2*SW^2)^2*Conjugate[USf[4, j1][s1, 1]]*USf[4, j1][s2, 1] + 
         ...
         4*SW^4*Conjugate[USf[4, j1][s1, 2]]*USf[4, j1][s2, \
2]))/(CW^2*SW^2)}}, 
 C[S[13, {s1, j1, o1}], -S[14, {s2, j2, o2}], V[1], \
V[3]] == 
  {{((I/3)*EL^2*$HKSign*Conjugate[CKM[j1, j2]]*Conjugate[USf[3, \
j1][s1, 1]]*
      IndexDelta[o1, o2]*USf[4, j2][s2, 1])/(Sqrt[2]*SW)}}, 
   ...
   C[S[11, {j1}], -S[12, {s2, j2}], V[1], V[3]] == 
    ...
    {{((-I)*EL^2*$HKSign*IndexDelta[j1, j2]*USf[2, j1][s2, \
1])/(Sqrt[2]*SW)}}, 
 C[S[12, {s2, j2}], -S[11, {j1}], V[1], -V[3]] == 
   ...
   C[S[12, {s2, j2}], -S[11, {j1}], V[2], -V[3]] == 
    ...
    {{(I*EL^2*Conjugate[USf[2, j1][s2, 1]]*IndexDelta[j1, \
j2])/(Sqrt[2]*CW)}}, 
 C[S[11, {j1}], -S[11, {j2}], V[3], -V[3]] == 
   ...
   C[S[12, {s1, j1}], -S[12, {s2, j2}], V[3], -V[3]] == 
    ...
    {{((I/2)*EL^2*Conjugate[USf[2, j1][s1, 1]]*IndexDelta[j1, j2]*
        ...
        USf[2, j1][s2, 1])/SW^2}}, C[S[13, {s1, j1, o1}], -S[13, {s2, j2, \
o2}], 
   ...
   C[S[14, {s1, j1, o1}], -S[14, {s2, j2, o2}], S[14, {s3, j3, o3}], 
    ...
    {{IndexDelta[j1, j4]*IndexDelta[j2, j3]*((-I)*GS^2*SUNTSum[o2, o3, o4, \
o1]*
           ...
           (Conjugate[USf[4, j1][s1, 1]]*(CB^2*(1 + 8*CW^2)*MW^2*
            ...
            2*Conjugate[USf[4, j1][s1, 2]]*(2*CB^2*MW^2*SW^2*
               ...
               (CB^2*MW^2*SW^2*USf[4, j1][s4, 2]*USf[4, j2][s2, 1] + 
                ...
                9*CW^2*MQD[j1]*MQD[j2]*USf[4, j1][s4, 1]*USf[4, j2][s2, \
2]))))/
        (CB^2*CW^2*MW^2*SW^2)) + IndexDelta[j1, j2]*IndexDelta[j3, \
j4]*
      ((-I)*GS^2*SUNTSum[o2, o1, o4, o3]*(Conjugate[USf[4, j1][s1, 1]]*

            USf[4, j1][s2, 1] - Conjugate[USf[4, j1][s1, 2]]*USf[4, j1][s2, \
2])*
           ...
           (Conjugate[USf[4, j1][s1, 1]]*(CB^2*(1 + 8*CW^2)*MW^2*
            ...
            2*Conjugate[USf[4, j1][s1, 2]]*(2*CB^2*MW^2*SW^2*
               ...
               (CB^2*MW^2*SW^2*USf[4, j1][s2, 2]*USf[4, j3][s4, 1] + 
                ...
                9*CW^2*MQD[j1]*MQD[j3]*USf[4, j1][s2, 1]*USf[4, j3][s4, \
2]))))/
        (CB^2*CW^2*MW^2*SW^2))}}, 
...
+ 
  ...
  {{((I/12)*EL^2*IndexDelta[j1, j2]*IndexDelta[j3, j4]*IndexDelta[o1, o2]*
        ...
        ((1 + 2*CW^2)*Conjugate[USf[4, j1][s1, 1]]*USf[4, j1][s2, 1] + 
         ...
         2*SW^2*Conjugate[USf[4, j1][s1, 2]]*USf[4, j1][s2, \
2]))/(CW^2*SW^2)}}, 
 C[S[14, {s1, j1, o1}], -S[14, {s2, j2, o2}], S[13, {s3, \
j3, o3}], 
   -S[13, {s4, j4, o4}]] == 

    {{IndexDelta[j1, j2]*IndexDelta[j3, j4]*((-I)*GS^2*SUNTSum[o2, o1, o4, \
o3]*
         ...
         (CB^2*Conjugate[USf[3, j3][s3, 2]]*Conjugate[USf[4, j1][s1, 1]]*
          ...
          SB^2*Conjugate[USf[3, j3][s3, 1]]*USf[3, j4][s4, 1]*
           ...
           (CB^2*MW^2*Conjugate[USf[4, j1][s1, 1]]*USf[4, j2][s2, 1] + 
            ...
            Conjugate[USf[4, j1][s1, 2]]*MQD[j1]*MQD[j2]*USf[4, j2][s2, \
2])))/
      (CB^2*MW^2*SB^2*SW^2)}}, C[S[14, {s1, j1, o1}], -S[12, {s2, \
j2}], 
   ...
   C[S[12, {s1, j1}], -S[14, {s2, j2, o2}], S[13, {s3, j3, o3}], 
    ...
    {{((-I/4)*EL^2*(Conjugate[USf[2, j1][s1, 1]]*
          ...
          (CB^2*MW^2*Conjugate[USf[2, j2][s3, 1]]*IndexDelta[j1, j4]*
           ...
           2*Conjugate[USf[2, j2][s3, 2]]*IndexDelta[j1, j4]*IndexDelta[j2, \
j3]*
         ...
         2*Conjugate[USf[2, j1][s1, 2]]*(2*CB^2*MW^2*SW^2*
            ...
            Conjugate[USf[2, j2][s3, 2]]*IndexDelta[j1, j4]*IndexDelta[j2, \
j3]*
          USf[2, j1][s4, 2]*USf[2, j2][s2, 2] + Conjugate[USf[2, j2][s3, \
1]]*
  ...
  {{((-I/12)*EL^2*IndexDelta[j1, j2]*IndexDelta[j3, j4]*IndexDelta[o3, o4]*
        ...
        ((3*CW^2 - SW^2)*Conjugate[USf[3, j3][s3, 1]]*USf[3, j3][s4, 1] + 
         ...
         4*SW^2*Conjugate[USf[3, j3][s3, 2]]*USf[3, j3][s4, \
2]))/(CW^2*SW^2)}}, 
 C[S[13, {s1, j1, o1}], -S[13, {s2, j2, o2}], S[13, {s3, \
j3, o3}], 
   -S[13, {s4, j4, o4}]] == 
           ...
           (Conjugate[USf[3, j1][s1, 1]]*((1 + 8*CW^2)*MW^2*SB^2*
            ...
            2*Conjugate[USf[3, j1][s1, 2]]*(8*MW^2*SB^2*SW^2*
               ...
               (-2*MW^2*SB^2*SW^2*USf[3, j1][s4, 2]*USf[3, j2][s2, 1] + 
                ...
                9*CW^2*MQU[j1]*MQU[j2]*USf[3, j1][s4, 1]*USf[3, j2][s2, \
2]))))/
        (CW^2*MW^2*SB^2*SW^2)) + IndexDelta[j1, j2]*IndexDelta[j3, \
j4]*
      ((-I)*GS^2*SUNTSum[o2, o1, o4, o3]*(Conjugate[USf[3, j1][s1, 1]]*

            USf[3, j1][s2, 1] - Conjugate[USf[3, j1][s1, 2]]*USf[3, j1][s2, \
2])*
        (Conjugate[USf[3, j3][s3, 1]]*USf[3, j3][s4, 1] - 
           ...
           (Conjugate[USf[3, j1][s1, 1]]*((1 + 8*CW^2)*MW^2*SB^2*
            ...
            2*Conjugate[USf[3, j1][s1, 2]]*(8*MW^2*SB^2*SW^2*
               ...
               (-2*MW^2*SB^2*SW^2*USf[3, j1][s2, 2]*USf[3, j3][s4, 1] + 
                ...
                9*CW^2*MQU[j1]*MQU[j3]*USf[3, j1][s2, 1]*USf[3, j3][s4, \
2]))))/
        (CW^2*MW^2*SB^2*SW^2))}}}
